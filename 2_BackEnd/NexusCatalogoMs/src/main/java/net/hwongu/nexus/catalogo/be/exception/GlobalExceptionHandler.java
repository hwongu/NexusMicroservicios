...
public class GlobalExceptionHandler {
     ...
     * {@code idCategoria} que no existe.</p>
     *
     ...
     * que aun esta siendo referenciado por otra tabla. Por ejemplo, cuando se
     * intenta borrar una categoria que todavia tiene productos asociados.</p>
     *
